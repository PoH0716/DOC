...
class SymptomsTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        Symptom.instance.syncDefaultSymptom()
    }
    
    override func viewDidAppear(_ animated: Bool) {
        User.instance.selectedType = "Symptoms"
    }
    
    func setSymptomCheckmarks(Category: String, Symptom: [String], section: Int) {
        db.collection("Users/\(User.instance.userId!)/Dates/\(User.instance.getDate())/Symptoms").document(Category).getDocument { (document, err) in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        setSymptomCheckmarks(Category: Symptom.instance.symptomCat[0], Symptom: Symptom.instance.symptomCat0, section: 0)
        setSymptomCheckmarks(Category: Symptom.instance.symptomCat[1], Symptom: Symptom.instance.symptomCat1, section: 1)
        setSymptomCheckmarks(Category: Symptom.instance.symptomCat[2], Symptom: Symptom.instance.symptomCat2, section: 2)
        setSymptomCheckmarks(Category: Symptom.instance.symptomCat[3], Symptom: Symptom.instance.symptomCat3, section: 3)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 1:
            ...
            case 1:
                ...
                self.performSegue(withIdentifier: "setSymptom", sender: nil)
            case 2:
