//
//  SetSymptomViewController.swift
//  DOC
//
...
class SetSymptomViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidAppear(_ animated: Bool) {
        Symptom.instance.fetchSymptom(userCompletionHandler: { user, error in
            if let user = user {
                self.index = user
    ...
    @IBAction func saveSymptom(_ sender: Any) {
        ...
        Symptom.instance.saveSymptom(Type: User.instance.selectedType, Category: User.instance.selectedCategory, Symptom: User.instance.selectedSymptom, Severity: User.instance.severity)
    }
