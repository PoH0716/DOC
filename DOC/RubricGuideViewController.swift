//
//  RubricGuideViewController.swift
//  DOC
//
...
class RubricGuideViewController: UIViewController, WKUIDelegate {
    ...
    override func viewDidLoad() {
        ...
        let path = Bundle.main.path(forResource: "RubricGuide", ofType: "pdf")
